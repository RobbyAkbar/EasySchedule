...
public class JadwalPelajaranAdapter extends BaseAdapter {
    ...
    public JadwalPelajaranAdapter (Context context, List<JadwalPelajaranModel> list){
    ...
    public JadwalPelajaranAdapter sortData(){
        Collections.sort(jadwalList, new Comparator<JadwalPelajaranModel>() {
            @Override
            public int compare(JadwalPelajaranModel jadwalPelajaranModel, JadwalPelajaranModel t1) {
                return jadwalPelajaranModel.getJam_mulai().compareTo(t1.getJam_mulai());
            }
        });
        return this;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        final JadwalPelajaranModel jadwal = jadwalList.get(i);
        final ViewHolder holder;
        if (view==null){
            view = inflater.inflate(R.layout.jadwal_pelajaran_list, null);
